...
def result_to_dict(result: ControllerResult) -> dict[str, Any]:
    return {
        ...
        "budget": {
            ...
            "worker_llm_calls": result.budget.worker_llm_calls,
            "worker_prompt_tokens": result.budget.worker_prompt_tokens,
            "worker_response_tokens": result.budget.worker_response_tokens,
            "worker_total_tokens": result.budget.worker_total_tokens,
            "synthesis_llm_calls": result.budget.synthesis_llm_calls,
            "synthesis_prompt_tokens": result.budget.synthesis_prompt_tokens,
            "synthesis_response_tokens": result.budget.synthesis_response_tokens,
            "synthesis_total_tokens": result.budget.synthesis_total_tokens,
